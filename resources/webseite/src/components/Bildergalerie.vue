...
export default defineComponent({
  ...
  data() {
    return {
      ...
      previews: [
        /*
      { src: "assets/img/about.jpg", cat: "cat1", caption: "Porta Nigra Platz" },
      { src: "/assets/img/trier/Railcars_at_Trier_Hauptbahnhof,_in_1945_(314837028).jpg", cat: "cat1", caption: "Porta Nigra Platz"  },
      { src: "/assets/img/trier/Reserve-Lazarett.jpg", cat: "cat2", caption: "Porta Nigra Platz"  },
      { src: "/assets/img/trier/Trier_Hauptmarkt.jpg", cat: "cat2", caption: "Porta Nigra Platz"  },
      { src: "/assets/img/trier/Trier_Palastkas.jpg", cat: "cat3", caption: "Porta Nigra Platz"  },
      { src: "/assets/img/trier/Trier_Viehmarktbrunnen.jpg", cat: "cat3", caption: "Porta Nigra Platz"  }, */
    {
  ...
  },
  {
    ...
    {
      src: "assets/img/trier/Projektseminar Bilder/Aerial_view_of_the_Roman_Bridge_at_Trier,_Germany,_circa_in_1956.jpg",
      date: "circa 1965",
      ort: "Römerbrücke, Trier",
      desc: "Aerial view of the Roman Bridge at Trier, Germany, circa in 1956. The photo was taken by an aircraft of the U.S. Air Force 10th Tactical Reconnaissance Wing, based at Spangdahlem Air Base, Germany.",
      licence: "public domain in the United States",
      urheber: "U.S. Air Force",
      url: "https://commons.wikimedia.org/wiki/File:Aerial_view_of_the_Roman_Bridge_at_Trier,_Germany,_circa_in_1956.jpg "
    },
    {
